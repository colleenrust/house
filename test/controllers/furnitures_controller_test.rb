...
class FurnituresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create furniture" do
    assert_difference("Furniture.count") do
      post furnitures_url, params: { furniture: { color: @furniture.color, function: @furniture.function, height: @furniture.height, name: @furniture.name, room_id: @furniture.room_id, weight: @furniture.weight } }
    end
  ...
  test "should update furniture" do
    patch furniture_url(@furniture), params: { furniture: { color: @furniture.color, function: @furniture.function, height: @furniture.height, name: @furniture.name, room_id: @furniture.room_id, weight: @furniture.weight } }
